 ...
 */
final class Version20210216200625 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE trip (id INT AUTO_INCREMENT NOT NULL, created_by INT NOT NULL, country_code VARCHAR(3) NOT NULL, started_at DATE NOT NULL, finished_at DATE NOT NULL, notes TEXT DEFAULT NULL, INDEX country_code (country_code), INDEX created_by (created_by), INDEX IDX_7656F53BD46F4E3 (started_at), INDEX IDX_7656F53B35CE7A2D (finished_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE trip ADD CONSTRAINT FK_7656F53BDE12AB56 FOREIGN KEY (created_by) REFERENCES account (id) ON DELETE CASCADE');
