 ...
 */
final class Version20210214170455 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE trip (id INT AUTO_INCREMENT NOT NULL, created_by INT NOT NULL, country_code VARCHAR(3) NOT NULL, started_at DATE NOT NULL, finished_at DATE NOT NULL, notes TEXT DEFAULT NULL, INDEX country_code (country_code), INDEX created_by (created_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
