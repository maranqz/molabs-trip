...
use TripBundle\Service\SerializerInterface;
...
class Controller extends AbstractController
{
    ...
    protected function validate($data, $asserts = null, $responseFormat = 'application/json')
    {
        ...
        if (count($errors) > 0) {
            ...
            foreach ($class->getProperties() as $property) {
                ...
                foreach ($annotations as $annotation) {
                    if ($annotation instanceof SerializedName) {
                        $serializeMatching[$property->name] = $annotation->name;
                    }
                }
            }
            ...
            foreach ($errors as $error) {
                ...
                if (isset($serializeMatching[$name])) {
                    $name = $serializeMatching[$name];
                }

                $messages[$name] = $error->getMessage();
            }

            return $this->createBadRequestResponse($this->serialize($messages, $responseFormat));
        }
    }
